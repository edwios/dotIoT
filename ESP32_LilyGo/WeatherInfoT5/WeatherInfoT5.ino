...
void onConnectionEstablished() {
    ...
    display.fillRect(0, 20, display.width(), display.height() - 48, GxEPD_WHITE);
    display.setTextColor(GxEPD_BLACK);
    display.setCursor(10, display.height() - 10);
    display.println("MQTT");
    display.updateWindow(0, 20, display.width(), display.height() - 21, true);
    client.subscribe("sensornet/env/+/status", [] (const String &payload)  {
        ...
        if (strncmp("environment", sensortype, 11*sizeof(char)) == 0) {
            ...
            if (strcmp(LOCATION_ID, sensornm) == 0) {
                ...
                sprintf(stemp, "T:%0.2fC", temp);
                sprintf(shumi, "H:%0.2f", humi);
                sprintf(slux, "Lux:%d lm", lux);
                ...
                display.setCursor(display.width() / 2, 68);
                display.println(slux);


                display.updateWindow(0, 20, display.width(), display.height() - 64, true);
            }
        }
  });
